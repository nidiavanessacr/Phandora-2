...
// 🔥 aceptar POST o GET (por compatibilidad)
...
// 🧠 verificar si ya existe en carrito ACTIVO
...
if ($row = $result->fetch_assoc()) {
    ...
    (usuario_id, producto_nombre, producto_precio, producto_imagen, cantidad, estado)
    VALUES (?, ?, ?, ?, 1, 'activo')";
